...
namespace Jasny\Bundle\ORMBundle\DependencyInjection;
...
class JasnyORMExtension extends Extension
{
    ...
    protected function setORMParameters(ContainerBuilder $container)
    {
        // Types
        $orm_types = array(
            'point' => 'Jasny\Bundle\ORMBundle\Types\PointType',
        ...
        $ormConfigDef->addMethodCall('addCustomNumericFunction', array('distance', 'Jasny\Bundle\ORMBundle\Functions\Distance'));
        $ormConfigDef->addMethodCall('addCustomNumericFunction', array('geom', 'Jasny\Bundle\ORMBundle\Functions\Geom'));
        */
    }
}
