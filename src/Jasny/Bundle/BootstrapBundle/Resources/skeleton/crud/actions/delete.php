...
{% if stringable %}
        $this->get('session')->setFlash('success', "{{ "Deleted %s '$entity'"|trans({'%s': entity_desc.singular})|capitalize }}");
{% else %}
        $this->get('session')->setFlash('success', "{{ "Deleted %s"|trans({'%s': entity_desc.singular})|capitalize }}");
{% endif %}
        }
